...
function corsMiddleware(_url, _req, res) {
  ...
  // ★ex03で追加★
  res.setHeader("Access-Control-Allow-Origin", "http://localhost:3000"); // リクエスト元を許可
  res.setHeader(
    "Access-Control-Allow-Methods",
    "GET, POST, PATCH, DELETE, OPTIONS"
  ); // 許可するHTTPメソッド
  res.setHeader("Access-Control-Allow-Headers", "Content-Type"); // 許可するHTTPヘッダー
  res.setHeader("Access-Control-Allow-Credentials", "true"); // Cookieを許可
